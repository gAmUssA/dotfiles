...
plugins=(ant atom battery bower brew compleat encode64 Forklift gem git-extras gitfast glassfish gradle grails grunt heroku httpie jsontools marked2 mercurial mvn node npm osx rake rbenv sublime svn web-search xcode z)
